...
from common.constants.travel_status import (
...
from common.llm_usage import get_usage, start_usage
from core.agents.agent_names import AGENT_TRAVEL_REQUEST
from core.agents.objects import AgentsObjectFactory
from core.dao.dao_names import DAO_TRAVEL_REQUEST
from core.dao.objects import DaoObjectFactory
from core.services.interfaces import TravelPlannerService
...
class TravelPlannerServiceImpl(TravelPlannerService):
    ...
    def execute(self, request: TravelRequest, ctx: TravelReqCtx) -> int:
        ...
        if ctx.user_id:
            if not ctx.user_preferences:
                ...
                from core.services.service_names import SERVICE_AUTH
    ...
    def _persist(self, request: TravelRequest, ctx: TravelReqCtx, travel_dao) -> None:
        ...
        elif result.get("guardrail_allowed") is False:
